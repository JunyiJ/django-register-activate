"""
Django settings for test_pk2 project.
...
SECRET_KEY = 'm0x%6^&skb4ic0$=oi%()_6b*+#4dadu@@)12#dj13p!1lwsa+'
...
WSGI_APPLICATION = 'test_pk2.wsgi.application'
